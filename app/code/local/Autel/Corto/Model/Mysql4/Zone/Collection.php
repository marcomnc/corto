 ...
 * @author marcoma
 */
class Autel_Corto_Model_Mysql4_Zone_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract 
{    
    ...
    public function getByGroup() {
        ...
        $this->getSelect()
             ->join(array('group' => Mage::getSingleton('core/resource')->getTableName('autelcorto/zonegroup')),
