...
class Autel_Corto_Block_Adminhtml_Zone_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {           
        $collection = Mage::getModel('autelcorto/zone')->getCollection();
        $collection->getSelect()
                   ->join (array('website' => Mage::getSingleton('core/resource')
                    ...
                    ->join (array('group' => Mage::getSingleton('core/resource')
                                                    ->getTableName('autelcorto/zonegroup')),
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('code', array(
            'header'=> Mage::helper('autelcorto')->__('Ws Code'),
            'align'     => 'right',
            'width'     => '40px',
            'index'     => 'code',            
        ));
        ...
        $this->addColumn('ws_name', array(
            'header'    => Mage::helper('autelcorto')->__('Website'),
            'index'     => 'ws_name',
            'width'     => '200px',
            'filter'    => false,
        ));
        ...
        $this->addColumn('Code', array(
            'header'    => Mage::helper('autelcorto')->__('Codice Zona'),  
            'index'     => 'zone_code',
            'width'     => '100px',
        ));        
        
        $this->addColumn('Description', array(
            'header' => Mage::helper('autelcorto')->__('Descrizione'),
            'index'  => 'description',
            'width'  => '400px',
        ));
        
        $this->addColumn('group_name', array(
            'header'=> Mage::helper('autelcorto')->__('Gruppo'),
            'width'     => '80px',            
            'index'     => 'group_name',
        ));

        $this->addColumn('sort_order_group', array(
            'header'=> Mage::helper('autelcorto')->__('Ord. Gruppo'),
            'align'     => 'right',
            'width'     => '40px',            
        ...
        $this->addColumn('sort_order', array(
            'header'=> Mage::helper('autelcorto')->__('Ord. Zona'),
            'align'     => 'right',
            'width'     => '40px',            
            'index'     => 'sort_order',
        ));
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()
             ->addItem('change_group', array(
                                'label'=> Mage::helper('autelcorto')->__('Change Group'),
