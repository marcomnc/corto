...
class Autel_Corto_Block_Adminhtml_Zone_Edit_Tab_Labels
    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    {
        return Mage::helper('autelcorto')->__('Labels');
    }
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('store_default_label', 'text', array(
            'name'      => 'store_labels[0]',
            'required'  => false,
            'label'     => Mage::helper('autelcorto')->__('Default Rule Label for All Store Views'),
            'value'     => isset($labels[0]) ? $labels[0] : '',
        ));

        $fieldset = $form->addFieldset('store_labels_fieldset', array(
            'legend'       => Mage::helper('autelcorto')->__('Store View Specific Labels'),
