 ...
 */
class  Autel_Corto_Block_Adminhtml_Widget_Grid_Column_Renderer_Submit_Checkbox extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Checkbox {
    
    
    /**
     * Modifico il nome per farlo passare nel submit
