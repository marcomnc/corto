                  ...
                  <div class="breadcrumbs">
                    <ul>
                      ...
                      <li class="last">
                        <?php
                            if ( is_day() ) :
                                printf( __( 'Daily Archives: %s', 'corto' ), '<span>' . get_the_date() . '</span>' );
                            elseif ( is_month() ) :
                                printf( __( 'Monthly Archives: %s', 'corto' ), '<span>' . get_the_date( 'F Y' ) . '</span>' );
                            elseif ( is_year() ) :
                                printf( __( 'Yearly Archives: %s', 'corto' ), '<span>' . get_the_date( 'Y' ) . '</span>' );
                            else:
                                _e( 'Archives', 'corto' );
                            endif;
                        ?>
