...
<?php // Marco Aggiunto la barra laterale da magento Non più usato in quanto è sull'header
            
/*			<script>
				// è necessario specificare l'url di partenza, per ora metot il negozio inglese
				var baseUrl="http://dev.autelfarm.net/corto/en/";
			</script>*/
?>
